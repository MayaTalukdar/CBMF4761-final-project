...
write.table(trainingDataFinalOutput, "trainingDataFinalOutput.txt", row.names = FALSE)
...
write.table(testingDataFinalOutput, "../Data/testingDataFinalOutput.txt", row.names = FALSE)
